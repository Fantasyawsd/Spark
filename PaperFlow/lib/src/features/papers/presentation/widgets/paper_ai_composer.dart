...
class PaperAiComposer extends StatelessWidget {
  ...
  final bool enabled;
  final bool sending;
  final PaperAiReasoningEffort reasoningEffort;
  final ValueChanged<PaperAiReasoningEffort> onReasoningEffortChanged;
            ...
            children: [
              TextField(
                ...
                decoration: const InputDecoration(
                  ...
                  isDense: true,
                  contentPadding: EdgeInsets.fromLTRB(4, 5, 4, 7),
                ),
              ),
                  ...
                  _ReasoningButton(
                    ...
                    onTap: sending
                        ...
                        : () => onReasoningEffortChanged(
                              reasoningEffort == PaperAiReasoningEffort.none
                                  ? PaperAiReasoningEffort.high
...
class _ReasoningButton extends StatelessWidget {
  ...
  final PaperAiReasoningEffort value;
  final bool enabled;
  final VoidCallback? onTap;

  @override
  Widget build(BuildContext context) {
    final selected = value != PaperAiReasoningEffort.none;
    final color = !enabled
