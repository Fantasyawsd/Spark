...
- 推荐频道混合高影响力、近期热点（GitHub star 增速、短期引用增速、经身份核验的 Web 热度、24–72 小时趋势增益）与个性化候选；卡片展示「Trending · 原因」与「为你推荐」徽标。
- 个性化推荐由设备本地行为日志聚合为匿名偏好画像随请求上送；行为采集可随时关闭与清除。
- 单页刷论文与双栏浏览选择。
...
- 个性化推荐开关与「清除行为数据」入口；行为数据纳入本地数据占用统计与清理。
