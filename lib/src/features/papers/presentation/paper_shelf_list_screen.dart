...
/// Full list page for a paper shelf (favorites, read later, reading history).
///
/// [PaperShelfListScreen.collection] shows one paper group at a time with
/// group chips; [PaperShelfListScreen.flat] shows a single list without
/// grouping. Both open a paper through [onOpenPaper].
...
class _PaperShelfListScreenState extends State<PaperShelfListScreen> {
  late String _selectedGroupId = defaultFavoriteGroupId;
