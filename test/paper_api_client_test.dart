...
void main() {
  test('recommended feed uses api.v1 and preserves its opaque cursor',
      () async {
    ...
    final page = await client.loadFeed(const PaperFeedQuery(
  ...
  test('subject and following feeds encode channel-specific filters', () async {
    ...
    expect(
        requestedUris.first.queryParameters, containsPair('from', isNotEmpty));
